...
#define hset_u8obj(map, k, v)       (hashmap_set_u8_to_object(map, k, v))
#define hget_u8obj(map, k)          (hashmap_get_u8_to_object(map, k))
...
#define u8obj_cmp   u8_to_object_cmp
